...
# cloning repo 
git clone -b main https://github.com/chandramouliravi/kagglepicemr.git /home/hadoop/png_to_jpg
...
s3-dist-cp --src /user/hadoop/clean_data --dest s3://bootstrap-and-emr-step-demo-rcm/clean_data
